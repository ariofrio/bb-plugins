...
test("sorts independent plugin releases by id", () => {
  const plan = buildReleasePlan([
    {
      directory: "plugins/bb-thread-workflow",
      before: plugin("bb-thread-workflow", "0.5.0", "Thread workflow"),
      after: plugin("bb-thread-workflow", "0.6.0", "Thread workflow"),
    },
    {
  ...
  assert.deepEqual(
    ...
    [
      { id: "bb-thread-workflow", tag: "bb-thread-workflow/v0.6.0" },
  ...
  assert.throws(
    () =>
      buildReleasePlan([
        {
          directory: "plugins/bb-thread-workflow",
          before: plugin("bb-thread-workflow", "0.5.0"),
          after: plugin("bb-thread-workflow", "0.4.0"),
        },
      ]),
